                                    ...
                                    <div class="card rounded-0 mb-0 p-2">
                                        <div class="card-header pt-50 pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0 text-center">{{ __('Create Gallery') }}</h4>
                                            </div>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form class="form-horizontal" method="post" action="{{ url('admin/save-gallery') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" name="about" class="form-control" placeholder="{{ __('Image Description') }}" >
                                                                </div>
                                                            </div>
                                                        </div>
