                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table zero-configuration">
                                                <thead>
                                                    <tr>
                                                        <th style="" class="text-center">{{ __('First Name') }}</th>
                                                        <th style="" class="text-center">{{ __('Last Name') }}</th>
                                                    ...
                                                    @foreach ($users as $user)
                                                        <tr>
                                                            ...
                                                            @if($user->status == "pending")
                                                                <td class="text-center bg-warning text-white text-uppercase">{{ $user->status }}</td>
                                                            @else
                                                                <td class="text-center bg-success text-white text-uppercase">{{ $user->status }}</td>
                                                            @endif

                                                            <td class="text-center">
                                                                <div class="btn-group">
                                                                    @if($user->status == "pending")
                                                                        <a class="btn btn-primary btn-sm text-white" href="{{ url('admin/approve-user', $user->id) }}">{{ __('Approve') }}</a>
                                                                    @endif
