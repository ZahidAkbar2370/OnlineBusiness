                    ...
                    <div class="product-gallery product-gallery-vertical">
                        <div class="row">
                            <figure class="product-main-image">
                                ...
                                <img id="product-zoom" src="{{ asset('') }}{{ $product->product_image_1 }}" data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-details-footer">
                            <div class="product-cat">
                                <span>Category:</span>
                                <a href="{{ url('shops/category/8') }}">{{ $product->ProductCategory->p_category_name ?? '' }}</a>,
                                {{-- <a href="#">Dresses</a>,
                                <a href="#">Yellow</a> --}}
                            </div><!-- End .product-cat -->
