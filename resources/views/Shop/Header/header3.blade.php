...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/skins/skin-demo-8.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/demos/demo-8.css')}}">
</head>
            ...
            <div class="header-bottom sticky-header">
                <div class="container">
                    ...
                    <div class="header-right">
                            ...
                            <div class="dropdown cart-dropdown">
                                ...
                                {{-- <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="dropdown-cart-action">
                                        <a href="{{ url('carts/'.$shopProfile->shop_url) }}" class="btn btn-primary">View Cart</a>
                        ...
                        @else
                            <a href="#" class="wishlist-link">
                                <a href="{{route('login')}}" style="color:rgb(17, 8, 8) ;margin-right: 8px">Login</a>
                                <a href="{{route('register')}}" style="color:rgb(22, 10, 10) ;">Register</a>
                            </a>
                        @endif
