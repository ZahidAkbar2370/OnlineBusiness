                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <h4 class="widget-title">about Online Layyah</h4><!-- End .widget-title -->
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis cum aperiam cumque dolor ad ratione ullam inventore! Voluptatibus recusandae quae, hic nam doloremque dolores expedita, voluptatum provident minima repellat numquam!</p>
